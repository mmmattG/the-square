...
run_test("expansion technology names can be parsed back into levels", function()
  assert_equal(expansion_research.get_level_from_technology_name("fes-square-expansion-nauvis-0001"), 1, "level 1 should parse")
  assert_equal(expansion_research.get_level_from_technology_name("fes-square-expansion-vulcanus-0041"), 41, "level 41 should parse")
  assert_equal(expansion_research.get_level_from_technology_name("automation"), nil, "non-expansion research should not parse")
end)

run_test("expansion technology names include the planet key", function()
  assert_equal(
    expansion_research.get_technology_name("nauvis", 7),
    "fes-square-expansion-nauvis-0007",
    "nauvis technologies should include the planet key"
  )
  assert_equal(
    expansion_research.get_planet_key_from_technology_name("fes-square-expansion-gleba-0013"),
    "gleba",
    "planet keys should parse back out of the technology name"
  )
end)
