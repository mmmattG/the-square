...
run_test("planet starter resource matrix is planet-local", function()
  assert_equal(names(defs.get_input_definitions("nauvis")), "coal,copper-ore,crude-oil,iron-ore,stone,uranium-ore,water,wood")
  assert_equal(names(defs.get_output_definitions("nauvis")), "sulfuric-acid")
